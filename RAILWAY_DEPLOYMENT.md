...
5. In **Variables** impostare:
   ...
   - `PRACTICE_EXECUTION_VARIANT=INVERSE` per la MIRROR operativa su OANDA Practice: `BUY→SELL`, `SELL→BUY`, TP nominale `+0,25 CHF`, SL nominale `-0,20 CHF`;
...
segnale. MIRROR/INVERSE e la corsia operativa e usa TP nominale `+0,25 CHF` e
...
quotazione. La corsia operativa usa TP nominale `+0,25 CHF` e SL nominale
