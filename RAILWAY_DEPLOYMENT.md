...
5. In **Variables** impostare:
   ...
   - `PRACTICE_EXECUTION_VARIANT=INVERSE` per la MIRROR operativa su OANDA Practice: direzione opposta, TP nominale `+0,60 CHF`, SL nominale `-0,20 CHF`;
...
segnale. La MIRROR operativa inverte BUY/SELL e usa TP nominale `+0,60 CHF` e
SL nominale `-0,20 CHF`. La corsia non selezionata resta
...
quotazione. La MIRROR operativa usa TP nominale `+0,60 CHF` e SL nominale
`-0,20 CHF`. XAUUSD continua a essere bloccato nell'esecuzione OANDA finche il suo modulo
