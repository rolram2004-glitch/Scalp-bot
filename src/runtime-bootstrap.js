...
if (
  ...
  // This Practice deployment intentionally executes the NORMAL/MAIN lane: a
  // BUY signal submits BUY and a SELL signal submits SELL. Protective prices
  ...
  // Keep the NORMAL direction unchanged and change only the monetary
  // protection amounts: TP +0.03 CHF and SL -0.30 CHF. BUY stays BUY and
  // SELL stays SELL.
  process.env.NORMAL_STOP_LOSS_ACCOUNT = "0.3";
  process.env.NORMAL_TAKE_PROFIT_ACCOUNT = "0.03";
}
...
console.log(
  ...
  `NORMAL=TP+0.03CHF/SL-0.30CHF maxUnits=1000 adaptiveSpreadSize=true exits=SL_TP_ONLY ` +
