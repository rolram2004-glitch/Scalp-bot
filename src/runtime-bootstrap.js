...
if (
  ...
  // Keep the NORMAL direction unchanged and swap only the monetary
  // protection amounts: TP +0.60 CHF and SL -0.10 CHF. BUY stays BUY and
  // SELL stays SELL.
  process.env.NORMAL_STOP_LOSS_ACCOUNT = "0.1";
...
console.log(
  ...
  `NORMAL=TP+0.60CHF/SL-0.10CHF maxUnits=1000 adaptiveSpreadSize=true exits=SL_TP_ONLY ` +
