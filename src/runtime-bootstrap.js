...
if (
  ...
  // Execute the opposite of every final MAIN signal exactly once: BUY opens
  // SELL and SELL opens BUY. Protective prices are derived from fixed CHF
  // amounts after the broker quote/fill is known; old pip levels are never
  // submitted.
  ...
  // Swap the previous exits: TP 2.00 becomes SL 2.00 and SL 0.20 becomes
  // TP 0.20. Indicator logic and scan rhythm remain unchanged.
...
console.log(
  ...
  `INVERSE=TP+0.20CHF/SL-2.00CHF maxUnits=1000 adaptiveSpreadSize=true exits=SL_TP_ONLY ` +
