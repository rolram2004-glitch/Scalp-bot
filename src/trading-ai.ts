...
const HYPER_FOREX = String(config.FOREX_SIGNAL_PROFILE) === "ROHATO_HYPER_100_PER_SYMBOL";
const AGGRESSIVE_FOREX = ["ROHATO_HYPER_100_PER_SYMBOL", "ROHATO_AGGRESSIVE_100", "AGGRESSIVE_25"].includes(
