    ...
    <div className="versus-page vs3">
      <section className="vs3-hero">
        <div>
          ...
          <p>Stesso Signal ID e direzione opposta. La corsia {selectedLane === 'MAIN' ? 'MAIN/NORMALE è operativa con direzione invariata, TP +0,60 CHF e SL -0,10 CHF' : 'MIRROR è operativa con TP +0,60 CHF e SL -0,10 CHF'}.</p>
        </div>
      ...
      <section className="vs3-truth-bar" aria-label="Significato delle due corsie">
        ...
        <div className="rule">
          ...
          <div className="vs3-mirror-rules" aria-label="Mappatura degli esiti MAIN e MIRROR">
            ...
            <div className="vs3-result-swap"><b className="win">PROTEZIONE FISSA</b><i>→</i><b className="loss">TP +0,60 · SL -0,10 CHF</b></div>
          </div>
