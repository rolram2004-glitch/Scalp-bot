    ...
    <div className="versus-page vs3">
      <section className="vs3-hero">
        <div>
          ...
          <p>Stesso Signal ID per il confronto. La corsia {selectedLane === 'MAIN' ? 'MAIN è operativa nella stessa direzione, con TP +0,33 CHF e SL -2,00 CHF' : 'MIRROR/INVERSE è operativa e inverte una volta qualunque segnale finale degli indicatori: BUY→SELL e SELL→BUY, con TP +0,33 CHF e SL -2,00 CHF'}.</p>
        </div>
      ...
      <section className="vs3-truth-bar" aria-label="Significato delle due corsie">
        ...
        <div className="rule">
          ...
          <div className="vs3-mirror-rules" aria-label="Mappatura degli esiti MAIN e MIRROR">
            ...
            <div className="vs3-result-swap"><b className="win">PROTEZIONE FISSA</b><i>→</i><b className="loss">TP +0,33 · SL -2,00 CHF</b></div>
          </div>
