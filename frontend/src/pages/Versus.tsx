    ...
    <div className="versus-page vs3">
      <section className="vs3-hero">
        <div>
          ...
          <p>Stesso Signal ID e direzione opposta. La corsia {selectedLane === 'MAIN' ? 'MAIN/NORMALE è operativa con direzione invariata, TP +0,20 CHF e SL -1,20 CHF' : 'MIRROR è operativa con TP +0,20 CHF e SL -1,20 CHF'}.</p>
        </div>
