    ...
    <div className="versus-page vs3">
      <section className="vs3-hero">
        <div>
          ...
          <p>Stesso Signal ID e motore dei segnali invariato. La corsia {selectedLane === 'MAIN' ? 'MAIN è operativa nella stessa direzione, con TP +0,25 CHF e SL -0,20 CHF' : 'MIRROR/INVERSE è operativa: BUY→SELL e SELL→BUY, con TP +0,25 CHF e SL -0,20 CHF'}.</p>
        </div>
      ...
      <section className="vs3-truth-bar" aria-label="Significato delle due corsie">
        ...
        <div className="rule">
          ...
          <div className="vs3-mirror-rules" aria-label="Mappatura degli esiti MAIN e MIRROR">
            ...
            <div className="vs3-result-swap"><b className="win">PROTEZIONE FISSA</b><i>→</i><b className="loss">TP +0,25 · SL -0,20 CHF</b></div>
          </div>
