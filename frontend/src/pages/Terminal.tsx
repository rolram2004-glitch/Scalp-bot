    ...
    <div className="dashboard-page">
      ...
      <section className="dashboard-primary-grid">
        ...
        <section className="signal-duel cockpit-panel">
          <header className="cockpit-panel__header">
            <div><span>{mirrorSelected ? 'MIRROR OPERATIVA · DIREZIONE OPPOSTA · TP +0,10 · SL -0,60 CHF' : 'MAIN OPERATIVA · DIREZIONE NORMALE INVARIATA · TP +0,10 · SL -0,60 CHF'}</span><h2>MAIN / MIRROR</h2></div>
            <div className="panel-header-tags">
